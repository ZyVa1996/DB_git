...
--
-- Temporary table structure for view `genevw`
--
...
/*!50001 VIEW `genevw` AS select `gene`.`id` AS `id`,`gene`.`mo_id` AS `mo_id`,`gene`.`acc` AS `acc`,`gene`.`descr` AS `descr`,`gene`.`len` AS `len` from `gene` */;
...
-- Dump completed on 2017-12-07 15:28:33
